...
String _$commentsHash() => r'5a5e2d6411acde3120e9b2d41ac4d8db17b34ee4';
...
class CommentsFamily extends Family<AsyncValue<List<Comment>>> {
  ...
  /// See also [comments].
  CommentsProvider call({required String postId}) {
    return CommentsProvider(postId: postId);
  }
...
class CommentsProvider extends AutoDisposeStreamProvider<List<Comment>> {
  /// See also [comments].
  CommentsProvider({required String postId})
    : this._internal(
        (ref) => comments(ref as CommentsRef, postId: postId),
...
String _$commentControllerHash() => r'5a93295f4ad76b97a12b46e5d46eead83a02081d';

/// See also [CommentController].
@ProviderFor(CommentController)
final commentControllerProvider =
    AutoDisposeAsyncNotifierProvider<CommentController, void>.internal(
...
typedef _$CommentController = AutoDisposeAsyncNotifier<void>;
